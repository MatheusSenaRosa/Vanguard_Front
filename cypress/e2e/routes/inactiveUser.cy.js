...
describe("Inactive User", () => {
  beforeEach(() => {
    cy.login("inativo-cypress@gmail.com", "12345_Aa");
  });
  ...
  it("can access activate account", () => {
    cy.visit("http://localhost:3000/ativar-conta");

    cy.getByDataCY("activate-account").should("exist");
  });
  ...
  it("redirects to activate account when access my profile", () => {
